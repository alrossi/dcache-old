...
public class QoSAdjusterTaskTest {
    ...
    @Test
    public void shouldCreateMigrationTask() {
        ...
        whenTaskIsRun();
        QoSAdjuster adjuster = task.getAdjuster();
        assertNotNull(adjuster);
        assertTrue(adjuster instanceof CopyAdjuster);
        assertNotNull(((CopyAdjuster)adjuster).getMigrationTask());

        // Should get the message from the mock pool
    }
