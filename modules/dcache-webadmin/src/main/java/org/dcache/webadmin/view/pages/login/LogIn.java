...
public class LogIn extends BasePage {
    ...
    private class LogInForm extends StatelessForm {
        ...
        private void setGoOnPage() {
            /*
             * Custom links, such as in panels, may instantiate this page with
             * an explicit return page. This is sometimes necessary, as the URL
             * generated by the normal intercept control flow will contain a
             * query part for the panel's listener, and redirecting there
             * produces an AccessDenied page.
             */
            if (returnPage != null) {
                setResponsePage(returnPage);
            } else {
                /*
                 * If this is an intercept page, an exception will be thrown
                 * which redirects to the originating page. If this method
                 * returns, the login originated here, so we just take the user
    ...
    public LogIn(BasePage returnPage) {
        super();
